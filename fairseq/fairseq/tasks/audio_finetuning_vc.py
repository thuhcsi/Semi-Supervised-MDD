...
from fairseq.data.add_target_vc_dataset import AddTargetVCDataset
...
@dataclass
class AudioFinetuningVCConfig(AudioPretrainingConfig):
...
@register_task("audio_finetuning_vc", dataclass=AudioFinetuningVCConfig)
class AudioFinetuningVCTask(AudioPretrainingTask):
    """ """

    cfg: AudioFinetuningVCConfig
    ...
    def load_dataset(self, split: str, task_cfg: AudioFinetuningVCConfig = None, **kwargs):
        ...
        self.datasets[split] = AddTargetVCDataset(
            self.datasets[split],
            labels,
