...
@dataclass
class SemiSupervisedCtcCriterionConfig(CtcCriterionConfig):
    alpha: float = field(
        default=.5,
...
@register_criterion("semi_supervised_ctc", dataclass=SemiSupervisedCtcCriterionConfig)
class SemiSupervisedCtcCriterion(CtcCriterion):
    def __init__(self, cfg: SemiSupervisedCtcCriterionConfig, task: FairseqTask):
